...
$(document).ready(function(){
    ...
    var answers = [
        ...
        ["In the church!", "Yes, In Prison!","If your tayor was your mom and you're a baby", "Yup at the doctors"],
    ...
    var correctResponses = [
        "Joey", "Yes, In Prison!", "Sandwich", "Gella Cup", "Phalange", "Bamboozled", "ATM Vestibule", "Janice"
    ];
    ...
    function question(){
        ...
        for (i=0; i < questions.length; i++) {
            ...
            $("#answers").html(
                "<form>" + 
                    "<input type='radio'>" + answers[i][0] + "<br>" +
                    "<input type='radio'>" + answers[i][1] + "<br>" +
                    "<input type='radio'>" + answers[i][2] + "<br>" +
                    "<input type='radio'>" + answers[i][3] + "<br>" +
                    "<button> Next </button>" +
                "</form>");
